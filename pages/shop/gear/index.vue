<template>
  <div>
    ...
    <main>
      <article>
          <h1>Shop Gear</h1>
          <p>Place sparring gear orders. Orders will be processed by CMAA staff, and payment will occur upon receiving of your weapons.</p>
      </article>
      <article>
...
export default {
  ...
  head () {
    return {
      title: 'Gear | CMAA',
      meta: [
        { name: 'description', content: 'Gear order forms' },
